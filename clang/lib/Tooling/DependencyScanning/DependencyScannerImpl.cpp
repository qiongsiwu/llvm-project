...
llvm::Error CompilerInstanceWithContext::computeDependencies(
  ...
  auto MDC = initializeScanInstanceDependencyCollector(
      CI, std::move(Opts), CWD, Consumer, Worker.Service, Inv, Controller,
      PrebuiltModuleVFSMap, StableDirs, false);
  ...
  auto LastCC1Arguments = Inv.getCC1CommandLine();
  auto LastCC1CacheKey = Controller.getCacheKey(Inv);
