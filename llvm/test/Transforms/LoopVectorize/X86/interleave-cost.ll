...
; CHECK-NEXT:    [[TMP24:%.*]] = load float, ptr [[TMP26]], align 4, !alias.scope [[META4:![0-9]+]]
; CHECK-NEXT:    [[TMP29:%.*]] = load float, ptr [[TMP13]], align 4, !alias.scope [[META4]]
; CHECK-NEXT:    [[TMP49:%.*]] = insertelement <2 x float> poison, float [[TMP24]], i32 0
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = insertelement <2 x float> [[TMP49]], float [[TMP29]], i32 1
; CHECK-NEXT:    [[TMP25:%.*]] = load float, ptr [[TMP16]], align 4, !alias.scope [[META4]]
; CHECK-NEXT:    [[TMP55:%.*]] = load float, ptr [[TMP17]], align 4, !alias.scope [[META4]]
; CHECK-NEXT:    [[TMP27:%.*]] = insertelement <2 x float> poison, float [[TMP25]], i32 0
; CHECK-NEXT:    [[STRIDED_VEC17:%.*]] = insertelement <2 x float> [[TMP27]], float [[TMP55]], i32 1
